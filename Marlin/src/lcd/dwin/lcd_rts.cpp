...
//	MYSERIAL0.write(0xCC);
//	MYSERIAL0.write(MYSERIAL1.available());
//	MYSERIAL0.write(0xCC);

//	MYSERIAL0.write(0xBB);
	do{
		if(MYSERIAL1.available() > 0){
			databuf[frame_index] = MYSERIAL1.read();
//			MYSERIAL0.write(0xff);
//			MYSERIAL0.write(frame_index);
//			MYSERIAL0.write(databuf[frame_index]);
			timeout = 0;
			/* 0x5A */
...
//		MYSERIAL0.write(0xAA);
		for(int idx = 0; idx < frame_index; idx++){
//			MYSERIAL0.write(databuf[idx]);
		}
//		MYSERIAL0.write(0xAA);
