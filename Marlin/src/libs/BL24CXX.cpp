...
#define SDA_IN()  do{ PIN_MAP[IIC_EEPROM_SDA].gpio_device->regs->CRL &= 0XFFFFF0FF; PIN_MAP[IIC_EEPROM_SDA].gpio_device->regs->CRL |= 0X00000800; }while(0)
#define SDA_OUT() do{ PIN_MAP[IIC_EEPROM_SDA].gpio_device->regs->CRL &= 0XFFFFF0FF; PIN_MAP[IIC_EEPROM_SDA].gpio_device->regs->CRL |= 0X00000300; }while(0)
